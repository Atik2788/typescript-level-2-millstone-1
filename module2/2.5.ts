{
  ...
  const resGenericPbj = createArrayWithGenerics<User>({
    id: 222,
    name: "Mr. Pashan",
  });
  ...
  const resGeneric2 = createArrayWithGenerics2<string, number>(
    "Bangladesh",
    222
  );

  const resGeneric3 = createArrayWithGenerics2<string, { name: string }>(
    "Bangladesh",
    { name: "Asia" }
  );
